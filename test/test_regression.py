...
RETRIEVER_GIS_REPO = "https://raw.githubusercontent.com/henrykironde/retriever/master/test/raw_data_gis/scripts/{script_names}.json"
...
test_sample = {
    'name': 'test-sample',
    'raw_data': ['site_id, state ,latitude, longitude, habitat_code',
...
RETRIEVER_TESTS_DATA = [test_sample]
...
def setup_postgres_retriever_db():
    ...
    install_dataset_postgres("test-sample")
